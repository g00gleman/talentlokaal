...
<html lang="en">
    ...
    <body class="bg-talent-green">
        ...
        <div class="flex justify-center full-panel">
            <div class="panel flex justify-center items-center flex-col">
                <div class="personal-image">
                    <label class="label">
                        <input type="file" />
                        <figure class="personal-figure">
                            <img
                                src="https://cdn.discordapp.com/attachments/917847940985401386/1075026034350637106/18601.png"
                ...
                <div class="panel-box flex justify-center flex-col">
                    <input
                        type="text"
                        class="textInput"
                    ...
                    <textarea
                        ...
                        id=""
                    ></textarea>
                    <input type="button" value="Opslaan" class="buttonInput" />
                </div>
            </div>
        </div>
        <script>
