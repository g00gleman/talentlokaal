        ...
        <div class="customCard">
            ...
            <div class="flex justify-center mt-8">
                <div class="grid grid-cols-5 gap-2">
                    ...
                    <div class="col-span-4 text-xs flex flex-col items-center font-bold text-talent-orange">
                        <input name="city" type="text" value="{{ $user->city }}">
                        <input name="street" type="text" value="{{ $user->street }} ">
                        <input name="houseNumber" type="text" value="{{  $user->houseNumber }} ">
                        <input name="postalCode" type="text" value="{{ $user->postalCode}}">
                    </div>
                    ...
                    <div class="col-span-4 text-xs flex items-center font-bold text-talent-orange">
                        <input name="employeeFunction" type="text" value="{{ $user->employee->function }}">
                    </div>
                    ...
                    <div class="col-span-4 text-xs flex items-center font-bold text-talent-orange">
                        <input name="employeeCertificate" type="text" value="{{ $user->employee->certificate }}">
                    </div>

                    <div class="col-span-5 text-center">
                        <button class="border border-black rounded-xl px-3 py-" type="submit">Opslaan</button>
                    </div>
                </div>
            </div>
        </div>
