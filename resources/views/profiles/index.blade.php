...
<div class="flex justify-end">
    <div class="customArrowbtn">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
             stroke="currentColor" class="w-4 h-4 text-talent-green">
            ...
            <div class="grid grid-cols-5 gap-2">
                ...
                @if(isset($user->employee))
                    ...
                    <div class="col-span-4 text-xs flex items-center font-bold text-talent-orange">
                            ...
                            {{-- @if($user->employee->function == null)
                ...
                @if(isset($user->employee))
                    ...
                    <div class="col-span-4 text-xs flex items-center font-bold text-talent-orange">
                        {{ !isset($user->employee->certificate) }}
                    </div>
                @endif
            </div>
        </div>
...
<div class="flex justify-center mb-10">
    <div class="customCard">
        ...
        <div class="flex justify-center mt-8">
            <div class="">
                <form method="post" action={{ route('dashboard.manageProfile.destroy', $user->id) }}>
                    @csrf
                    @method('delete')
                    <div class="px-3 py-2 bg-talent-white rounded-full">
                        <button type="submit" class="text-center h-full select-none bg-red-500 font-bold">
                            Account verwijderen
                        </button>
                    </div>
                </form>
