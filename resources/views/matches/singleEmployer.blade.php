    ...
    <div class="w-full h-64 bg-talent-white rounded-b-3xl" id="top">
        ...
        <div class=" flex justify-center items-center">
            <div class=" rounded-xl bg-talent-light-green h-auto w-96 mt-24 shadow-lg shadow-black">
                ...
                <div class="text-talent-orange text-center font-bold text-3xl">{{ $employee->user->name }}</div>
                <div class="text-talent-green text-sm overflow-y-auto h-32 mt-5 ml-5 mr-5 mb-7">{{ $employee->user->description }}</div>
            </div>
        </div>
        <div class=" flex justify-center items-center">
                ...
                <div class=" flex justify-center mt-5">
                    @if (isset($employee->user->pitch))
                        <video width="320" height="240" controls="controls" >
                            <source src="{{ $employee->user->getProfilePitchUrlAttribute() }}" type="video/mp4" />
                        </video>
                    @endif
                </div>
            </div>
