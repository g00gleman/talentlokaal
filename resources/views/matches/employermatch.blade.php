...
<x-guest-layout>
    ...
    <div class="w-full h-64 bg-talent-white rounded-b-3xl">
        ...
        <div class=" flex justify-center mt-8 mr-16">
            <form>
                ...
                @foreach ($employees as $employeee)
                    <a href="/dashboard/employee/{{ $employeee->id }}">
                        ...
                        <div class=" shadow-lg w-80 bg-talent-white rounded-xl  flex items-center mb-6 h-32 ">
                                ...
                                Sector: {{ $employeee->jobCategorie->categoryName }}

                                <div class="font-sans font-bold  text-sm mb-5 text-talent-orange">
                                    Match percentage: {{ $employeee->matchPercentage }}%
                                </div>
                            ...
                            <div class=" flex-2 mr-5 ml-3 ">
                                <img class="h-20 w-20 rounded-full object-cover"
                                    src="{{ $employeee->user->getProfilePhotoUrlAttribute() }}"
                                    alt="{{ Auth::user()->name }}" />
                            </div>
