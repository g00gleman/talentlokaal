    ...
    <div class="body-flex">
        ...
        <div class=" flex justify-center m-auto">
            <div class=" rounded-lg">
                <table class="w-full text-sm text-left text-talent-orange dark:text-talent-orange rounded-full ml-10 mr-10 ">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-talent-light-green border-b dark:bg-talent-light-green dark:border-talent-light-green">
                            <th scope="row" class="py-4 px-6 font-medium dark:text-talent-green whitespace-nowrap ">
