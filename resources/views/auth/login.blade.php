...
<div class="justify-center flex mb-6">
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                <x-jet-input id="email" class=" font-sans focus:ring-talent-orange px-5 border-none block mt-1 w-64 rounded-full shadow-xl" type="email" name="email" :value="old('email')"  placeholder="Emailadres" required autofocus />
            </div>
         ...
         <div class="text-xs flex text-talent-red ml-5 mt-5 mr-5">
                @error('email')
                {{$message}}
                @enderror
            </div>
