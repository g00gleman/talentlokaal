<x-guest-layout>
    <div class="bg-talent-light-green ml-2 mr-2 rounded-xl flex justify-center items-center m-64 w-96">
        <div>
            <div class="flex-1 mt-3 ml-5">
                <?xml version="1.0" encoding="UTF-8"?><svg id="Laag_1" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 559.14 263.07" class=" w-80 mb-28">
                    <defs>
                        <style>
                            .cls-1 {
                                fill: #ef840c;
            ...
            <div class="justify-center flex mb-6">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="name" class=" px-5 border-none block mt-1 w-64 rounded-full shadow-xl"
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="email" class="px-5 border-none block mt-1 w-64 rounded-full shadow-xl"
                            type="email" name="email" :value="old('email')" required placeholder="Email" />
                    </div>

                    <div class="mt-4">

                        <x-jet-input id="password" class="px-5 border-none block mt-1 w-64 rounded-full shadow-xl"
                    ...
                    <div class="mt-4">
                        <x-jet-input id="password_confirmation"
                            class="px-5 border-none block mt-1 w-64 rounded-full shadow-xl" type="password"
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <a class="none-underline text-sm text-talent-white hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                            href="{{ route('login') }}">
            ...
            <div class="justify-center flex mb-11">
                <x-jet-button
                    class="ml-4 bg-talent-orange w-64 m-5 rounded-full text-talent-white justify-center shadow-xl">
                    {{ __('Register') }}
                </x-jet-button>
            </div>
        </div>
