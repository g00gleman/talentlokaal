...
<div class="justify-center flex mb-6">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="name" class=" px-5 border-none block mt-1 w-64 rounded-full shadow-xl" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Naam" />
            </div>

            <div class="mt-4">
           
                <x-jet-input id="email" class="px-5 border-none block mt-1 w-64 rounded-full shadow-xl" type="email" name="email" :value="old('email')" required placeholder="Email" />
            </div>
