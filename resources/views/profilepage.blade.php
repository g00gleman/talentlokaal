...
<html lang="en">
    ...
    <body class="bg-talent-green">
        ...
        <div
            class="mt-20 ml-14 mr-14 w-auto h-auto rounded-xl bg-talent-light-green"
        >
            <div class="p-5">
                <div class="flex w-full justify-center">
                    <img
                        src="https://cdn.discordapp.com/attachments/1017224704421011486/1063530859644330105/images.png"
                        alt=""
                        class="rounded-full w-24 h-24"
                    />
                </div>
                <div
                    class="flex w-full justify-center mt-2 text-2xl font-bold text-talent-orange"
                >
                    Sophie Jansen
                </div>
                <div class="text-xs mt-2 ml-4 mr-4 text-talent-green">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Nemo sint corporis blanditiis? Exercitationem vero id
                    corrupti? Sint adipisci autem cupiditate?
                </div>
            </div>
        </div>
        <div class="flex justify-end">
            <div
                class="w-6 h-6 mt-4 mb-4 mr-8 rounded-full flex justify-center items-center text-talent-green bg-talent-white"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
        ...
        <div class="ml-14 mr-14 w-auto h-auto rounded-xl bg-talent-light-green">
            <div
                class="flex justify-center text-talent-green font-bold text-lg pt-2"
            >
                Kennismaking Pitch
            </div>
            <div class="flex justify-center">
        ...
        <div
            class="ml-14 mr-14 mb-10 pb-6 pt-2 w-auto h-auto rounded-xl bg-talent-light-green"
        >
            <div
                class="flex justify-center text-talent-green font-bold text-lg pb-4"
            >
                Persoongegevens
            </div>
            <div class="flex justify-center">
