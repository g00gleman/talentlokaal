            ...
            <div class="nav-content">
                <a href="/dashboard" class="nav-content-btn" id="home">
                    <div class="nav-content-end">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mb-2 mr-4"
                ...
                <a href="{{ route('dashboard.manageProfile.index') }}" class="nav-content-btn" id="profile">
                    <div class="nav-content-end">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mb-2 mr-4"
                            viewBox="0 0 50.000000 50.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#000000"
                ...
                <a @if (Auth::user()->employee) href="{{ route('dashboard.matches.index') }}"
                    @elseif(Auth::user()->employer) href="/dashboard/matchesEmployer" @endif
                    class="nav-content-btn" id="matches">
                    <div class="nav-content-end">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mb-2 mr-4"
                            viewBox="0 0 50.000000 50.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#000000"
                ...
                @if (Auth::user()->employer)
                    <a href="{{ route('dashboard.jobOffer.index') }}" class="nav-content-btn" id="jobOffer">
                        <div class="nav-content-end">
                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-12 h-12 mb-2 mr-4"
                ...
                @endif
                <a href="/dashboard/support" class="nav-content-btn" id="support">
                    <div class="nav-content-end">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mb-2 mr-4"
                            viewBox="0 0 50.000000 50.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#000000"
                ...
                <button class="nav-content-btn" onclick="openModal(); closeMenu();">
                    <div class="nav-content-end">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mb-2 mr-4"
                            viewBox="0 0 50.000000 50.000000" preserveAspectRatio="xMidYMid meet">
                            <g transform="translate(0.000000,50.000000) scale(0.100000,-0.100000)" fill="#000000"
