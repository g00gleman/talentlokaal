...
<html lang="en">
    ...
    <body class="bg-talent-green">
        ...
        <div class="center">
            @foreach ($employer->jobOffers as $jobOffer)
            <div class="card">
                <div class="card__function">
                    <span class="card--bold">Functie: </span>
                    {{ $jobOffer->function }}
                </div>
                <div class="card__category">
                    <span class="card--bold">Categorie: </span>
                    {{ $jobOffer->jobCategorie->categoryName }}
                </div>
                <div class="card--flex">
                    <div class="card__button button--edit">
                        <a
                            href="{{ route('dashboard.jobOffer.edit', $jobOffer->id) }}"
                            >Wijzig</a
                        >
                    </div>
                    <div class="card__button button--delete">
                        <form
                            action="{{ route('dashboard.jobOffer.destroy', $jobOffer->id) }}"
                            method="post"
                        >
                            @csrf @method('delete')
