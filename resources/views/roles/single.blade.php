     ...
     <div class="flex justify-center items-center">
            ...
            <div class="justify-center flex mb-6">
                    ...
                    <div class=" flex mt-4">
                        ...
                        <x-jet-input id="profilePhoto" class=" px-5 border-none block mt-1 w-64 rounded-full shadow-xl placeholder:text-talent-orange" type="text" name="profielfoto" :value="old('profielfoto')" required autofocus placeholder="Vul hier je profielfoto in" />
                    </div>
                    {{-- certificate --}}
                    <div class=" flex mt-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 mr-5">
